...
<div class="container  pull-left">
	...
	<div class="collapse navbar-collapse pull-left" id="navbar-collapse">
		...
		<ul class="nav navbar-nav">
			<li class="<%=menu[8]%>"><a href="mng_re_trns?menu=8"><spring:message code="INVOICEmgmt" text="INVOICEmgmt"/></a></li>
			<li class="<%=menu[0]%>"><a href="mng_buy_plan?menu=0"><spring:message code="PURCHASEmgmt" text="PURCHASEmgmt"/></a></li>
			<li class="<%=menu[1]%>"><a href="mng_biz_plan?menu=1"><spring:message code="SALESmgmt" text="SALESmgmt"/></a></li>
			<li class="<%=menu[2]%>"><a href="mng_production_plan?menu=2"><spring:message code="PRODPLANmgmt" text="PRODPLANmgmt"/></a></li>
			<li class="<%=menu[3]%>"><a href="mng_stock_plan?menu=3"><spring:message code="STOCKmgmt" text="STOCKmgmt"/></a></li>
			<!-- li class="<%=menu[5]%>"><a href="mng_delivery?menu=5">배송관리</a></li-->
			
			 <%-- <li class="<%=menu[11]%>"><a href="mng_export_master?menu=11">반출증 관리</a></li> --%>
			
			<li class="<%=menu[4]%>"><a href="mng_noti?menu=4"><spring:message code="NOTICEbrd" text="NOTICEbrd"/></a></li>
			<li class="<%=menu[6]%>"><a href="mng_cw_noti?menu=6"><spring:message code="PARTbrd" text="PARTbrd"/></a></li>
			<li class="<%=menu[7]%>"><a href="mng_data_file?menu=7"><spring:message code="DATAbrd" text="DATAbrd"/></a></li>
			
			<!-- 메일 발송용 협력사 관리자 관리용 관리자 관리 탭 --> 
			<%if("master".equals(admin_id)){ %>
				<li class="<%=menu[9]%>"><a href="mng_partner_whole?menu=9"><spring:message code="PARTmgmt" text="PARTmgmt"/></a></li>
			<%} %>
			<%-- <%if("master".equals(admin_id)){ %>

      ...
      <!-- /.container-fluid -->
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<span style="float:left; font-size: 30px;">자료실</span>
				...
				<div class="row" style="width: 100%; margin-bottom: 5px; padding-bottom: 5px;">
					<!-- 공통 검색 조건 -->
						...
						<div class="col-xs-12" style="padding-right: 0px;">
							...
							<input type="text" id="startdate" name="startdate" style="width:125px; margin-right:5px;" autocomplete="off" readonly placeholder="연도-월-일"/>
							~
							<!-- <input type="text" id="enddate" name="enddate"	autocomplete="off" style="margin-right: 20px; width: 100px">  -->
							<input type="text" id="enddate" name="enddate" style="width:125px; margin-right:20px;" autocomplete="off" readonly placeholder="연도-월-일"/>
							
							<span> 제목 : </span> &nbsp;<input type="text" id="p_title"	autocomplete="off"	name="p_title" style="margin-right:15px;width: 100px"	value="" 
							onKeypress="javascript:if(event.keyCode==13) {getUserList('1')}"
							/>&nbsp;&nbsp;
							<span> 내용 : </span> &nbsp;<input type="text" id="s_contents"	autocomplete="off"	name="s_contents" style="margin-right:15px; width: 200px"	value="" 
							onKeypress="javascript:if(event.keyCode==13) {getUserList('1')}"
							/>&nbsp;&nbsp;
							<input		type="button" class="btn btn-warning" onclick="getUserList('1')"
								value="조회하기" style="margin-left: 50px;margin-right: 50px;" id="ok"/>
							...
							<div class="box">
								...
								<div class="box-body">
									...
									<table id="tablebody" width="100%"
										...
										<thead>
											<tr>
												<th style="font-size: 18px; text-align:center">번호</th>
												<th style="font-size: 18px; text-align:center">제목</th>
												<th style="font-size: 18px; text-align:center">등록자</th>
												<th style="font-size: 18px; text-align:center">등록일자</th>
												<th style="font-size: 18px; text-align:center">조회수</th>
												...
												<c:when test="${ board.size() > 0 }">
													...
													<c:set var="i" value="${i+1 }" />
														<tr>
															...
															<td style="font-size: 18px; text-align:center" width="20%">우보테크</td>

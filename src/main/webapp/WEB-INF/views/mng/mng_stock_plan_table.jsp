		...
		<div class="box">
			...
			<div class="box-body tableWrapper" style="overflow: scroll; padding: 0 0 0 0;">
				...
				<table id="tablebody" width="100%" class="stripe row-border order-column" cellspacing="0" style="borderSpacing:0; borderCollapse:separate; ">
										...
										<thead>
											<tr>
												<th class="sticky-th" rowspan="3"style="text-align: center;">순번</th>
												<th class="sticky-th" rowspan="3" style="text-align: center;">품명</th>
												<th class="sticky-th" rowspan="3" style="text-align: center;">규격</th>
												<th class="sticky-th" rowspan="3" style="text-align: center;">품목구분</th>
												<th class="sticky-th" rowspan="3" style="text-align: center;">단위</th>
												<th class="sticky-th" colspan="8" style="text-align: center;">창고재고</th>
												<th class="sticky-th" colspan="6" style="text-align: center;">재공재고</th>
												<th class="sticky-th" colspan="2" style="text-align: center;">총계</th>
												
												
											</tr>
											<tr>
												<th class="sticky-th-2nd" colspan="2" style="text-align: center;">제품</th>
												<th class="sticky-th-2nd" colspan="2" style="text-align: center;">발포</th>
												<th class="sticky-th-2nd" colspan="2" style="text-align: center;">자재</th>
												<th class="sticky-th-2nd" colspan="2" style="text-align: center;">해외</th>
												<th class="sticky-th-2nd" colspan="2" style="text-align: center;">블로우</th>
												<th class="sticky-th-2nd" colspan="2" style="text-align: center;">발포</th>
												<th class="sticky-th-2nd" colspan="2" style="text-align: center;">A/REST</th>
												<th class="sticky-th-2nd" colspan="2" style="text-align: center;">총계</th>
											</tr>	
											<tr>
												<th class="sticky-th-3rd" style="text-align: center;">양품</th>
												<th class="sticky-th-3rd" style="text-align: center;">불량</th>
												<th class="sticky-th-3rd" style="text-align: center;">양품</th>
												<th class="sticky-th-3rd" style="text-align: center;">불량</th>
												<th class="sticky-th-3rd" style="text-align: center;">양품</th>
												<th class="sticky-th-3rd" style="text-align: center;">불량</th>

...
<body class="hold-transition skin-blue layout-top-nav">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<span style="float:left; font-size: 30px;">반출증관리</span>
	...
	//★★★★★삭제예정220721★★★★★끝
		...
		function checkAll(controller, target) {
		 ...
		 function getUserList(page, keyword) {
		 	...
		 	var pageView = "mng_export_master_table";
	...
	//★★★★★삭제예정220721★★★★★시작	
		...
		function rejprint(pno,trbarcode,memo){
			...
			window.open("mng_label_rejprint?pno="+pno+"&trbarcode="+trbarcode+"&memo="+memo,"Report Print",'height=500, width=500');
			//window.open("mng_label_jprint","Report Print",'height=500, width=500');
			
		}
		//★★★★★삭제예정220721★★★★★끝
		
		function exportJ(barcode, indate){
			var barcode = barcode;
			var indate = indate;
			console.log(barcode+"220622"+indate);
			$.ajax({
				type : "post",
				url : "mng_export_data",
				dataType : "html",
		...
		function jprintdouble(pno,trbarcode,memo){
			window.open("mng_label_jprintDouble?pno="+pno+"&trbarcode="+trbarcode+"&memo="+memo,"Report Print",'height=500, width=500');
		}
		...
		function a4print(pno,trbarcode,memo){
			...
			window.open("mng_label_a4reprint?pno="+pno+"&trbarcode="+trbarcode+"&memo="+memo,"Report Print",'height=500, width=500');
			//window.open("mng_label_jprint","Report Print",'height=500, width=500');
		...
		function fnAllLabel(barcode){
			//alert(barcode);
			window.open("mng_label_labelAll?barcode="+barcode,"Report Print",'height=500, width=500');
		}
	...
	function a4double(pno,trbarcode,memo){
			...
			window.open("mng_label_a4double?pno="+pno+"&trbarcode="+trbarcode+"&memo="+memo,"Report Print",'height=500, width=500');
			//window.open("mng_label_jprint","Report Print",'height=500, width=500');

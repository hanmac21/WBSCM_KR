							...
							<div class="box">
								...
								<div class="box-body" style="overflow: scroll;">
									...
									<table id="tablebody" width="100%"
										...
										<thead>
											<tr>
												<th style="text-align: center; width: 3%;">순번
												</th>
												<th style="text-align: center; width: 7%;">거래처<br>&lt;납품처코드&gt;
												</th>
												<th style="text-align: center; width: 25%;">품번<br>(품명)
												</th>
										...
										<tbody>
											<c:choose>
												...
												<c:otherwise>
													<tr>
														<td colspan="18" style="height: 100px; text-align: center;">검색된 자료가없습니다.</td>
													</tr>
												</c:otherwise>

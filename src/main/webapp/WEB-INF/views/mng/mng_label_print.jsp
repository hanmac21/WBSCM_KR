  ...
  <c:choose>
	...
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title"><span> &nbsp;&nbsp;</span>라벨 바코드 발행 <!--  <span> &nbsp;&nbsp;</span> <button type="button" class="btn btn-info"
			...
			<h4 class="modal-title">
					...
					onclick="a4print('${itemcode1}','${board[0].trbarcode }','${memo }')">A4 인쇄</button>	
					
					<button type="button" class="btn btn-info"
					onclick="a4double('${itemcode1}','${board[0].trbarcode }','${memo }')">A4 인쇄(각 2부)</button>
					
					<button type="button" class="btn btn-info" style="margin-left : 20px;"
					onclick="jprint('${itemcode1}','${board[0].trbarcode }','${memo }')">라벨 프린터 인쇄</button>
					
					<button type="button" class="btn btn-info" 
					onclick="jprintDouble('${itemcode1}','${board[0].trbarcode }','${memo }')">라벨 프린터 인쇄(각 2부)</button>
												...
												<table class="table2" width="100%" height="250px"  border="1" bordercolor="#A2AFCC" bordercolorlight="#ffffff" bodercolordark="#6c717d" cellspacing="0" cellpadding="0">
													<tbody>
														...
														<tr>
															...
															<td class="td" colspan="2" width="40%" style="text-align: center;" >${custname}</td><td class="td"  colspan="2"  width="10%" style="font-size: 12px;text-align: center;" >검사: <input type="text" style="width:40px;border: none; background: transparent;" value="완료"> </td>
														</tr>
...
$("#chk").change(function() {console.log("20220711확인1");
	var element = Number(document.getElementById('.asPname'));
    if(this.checked) {	console.log("20220711확인2" +boardSize);
    	for(var i = 1 ; i<=boardSize; i++){console.log("20220711확인3");
    		var id = "asPname"+i;

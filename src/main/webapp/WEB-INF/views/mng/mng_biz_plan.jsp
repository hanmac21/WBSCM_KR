...
<body class="hold-transition skin-blue layout-top-nav">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<span style="float:left; font-size: 30px;">영업계획관리</span>
			...
			<section class="content">
				...
				<div class="row" style="width: 100%; margin-bottom: 5px; padding-bottom: 5px;">
					...
					<div class="col-xs-12" style="padding-right: 0px;">
						...
						<input type="button" class="btn btn-success" value="엑셀 저장" onclick="showExcel();" style="margin-left: 25px;"/>	
	...
	<script src="resources/js/jquery.number2.js"></script>

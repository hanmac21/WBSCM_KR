										...
										<td width="50%">
											...
											<div>
												...
												<div class="row" style="margin-left: 10px; float: left;">			
													<span style="font-size: 12px; ">수량합계 :</span> &nbsp; &nbsp;<span id="p_sumqty" style="height:26px;"><fmt:formatNumber value="${sumqty}" pattern="#,##0" /></span><br>										
													...
													<button type="button" class="btn" onclick="fnMemoSet2('${barcode}')" style="font-size: 12px; margin-left:1px; margin-bottom:1px; height:29px;" id="ok2">적용</button> <br>
													...
													<span style="font-size: 12px; ">작성일자 :</span> &nbsp; <input
														...
														<button type="button" class="btn" onclick="fnMemoSet3('${barcode}')" style="font-size: 12px;  margin-top:-1px;  height:29px;" id="ok2">적용</button> <br>

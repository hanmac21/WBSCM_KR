						...
						<div class="box-footer">
							...
							<div class="col-sm-12" style="text-align: center;">
								<button type="button" class="btn btn-info"
									onclick="fndelivery_u2('${deliveryno}','${dstate}')" style="margin-right: 10px;">배송완료</button>
								<button type="button" class="btn btn-success"
									 data-dismiss="modal" onclick="fnclose()">취소</button>
							</div>
...
function fnDeliveryTimeSet(){
	...
	if(pHour==''){
		alert('배송시간(시)을 선택해주세요');
		return;
	}
	if(pMin==''){
		alert('배송시간 (분)을 선택해주세요');
		return;
	}

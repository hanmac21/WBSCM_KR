	...
	<%
		...
		try{
			...
			if(labelType.equals("B")){
				if(chk.equals("1")){
					fileName = "/report/WB_Label_90x55_Double_AS.pdf";
				}else{
						fileName = "/report/WB_Label_90x55_Double.pdf";
				}
			}else{
				if(chk.equals("1")){
					fileName = "/report/WB_Label_9x7_Double_AS.pdf";
				}else{
						fileName = "/report/WB_Label_9x7_Double.pdf";
				}
			}

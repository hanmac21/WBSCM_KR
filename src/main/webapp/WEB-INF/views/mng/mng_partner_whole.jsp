      ...
      <!-- /.container-fluid -->
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<span style="float:left; font-size: 30px;">협력사 관리</span>
			...
			<section class="content">
				...
				<div class="row" style="width: 100%; margin-bottom: 5px; padding-bottom: 5px;">
					...
					<div class="col-xs-12" style="padding-right: 0px;">
						<span> 협력사 : </span> &nbsp;<input type="text" id="cu_sangho"	 autocomplete="off"	name="cu_sangho" style="margin-right:10px; width: 100px;"	 
						onKeypress="javascript:if(event.keyCode==13) {getUserList('1')}"
						/>	
							
					    <span> 사업자번호 : </span> &nbsp;<input type="text" id="cu_code"	autocomplete="off"	name="cu_code" style="margin-right:10px; width: 100px"	
					    onKeypress="javascript:if(event.keyCode==13) {getUserList('1')}"
					    />	
						    
					    <span> 대표자 : </span> &nbsp;<input type="text" id="cu_master"	autocomplete="off"	name="cu_master" style="margin-right:10px; width: 100px"	 
					    onKeypress="javascript:if(event.keyCode==13) {getUserList('1')}"
					    />	
						    
					    <span> 주소 : </span> &nbsp;<input type="text" id="cu_juso"	autocomplete="off"	name="cu_juso" style="margin-right:10px; width: 100px"	
					    onKeypress="javascript:if(event.keyCode==13) {getUserList('1')}"
					    />	
									...
									<table id="tablebody" width="100%" class="stripe row-border order-column" cellspacing="0" >
										...
										<thead>
											<tr>
												...
												<th style="text-align: center; font-size: 18x;">메일전송</th>

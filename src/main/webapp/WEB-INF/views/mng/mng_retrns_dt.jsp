			...
			<div class="modal-header">
				...
				<div style="width: 100%" style="float: right;">
								...
								<c:choose>
									...
									<c:otherwise>
										<button type="button" class="btn btn-info pull-right print_btn" id="print1"  
											style="margin-left: 15px" onclick="jtrnsprint('${barcode}','${memo}')">인쇄</button>
									</c:otherwise>
								...
								<button type="button" class="btn btn-warning pull-right"
									style="margin-right: 10px" onclick="fnMemoSet('${barcode}')" id="ok2">적용</button>
										...
										<td width="50%">
											...
											<div>
												...
												<div class="row" style="margin-left: 10px; float: left;">
													<span style="font-size: 12px">수량합계 : </span> &nbsp;&nbsp;<span id="p_sumqty"><fmt:formatNumber value="${sumqty}" pattern="#,##0" /></span><br>
													...
													<button type="button" class="btn" onclick="fnMemoSet2('${barcode}')" style="font-size: 12px; margin-left:1px; margin-bottom:1px; height:28px;" id="ok2">적용</button> <br>
													...
													<span style="font-size: 12px">작성일자 :</span> &nbsp; <input
														...
														<button type="button" class="btn" onclick="fnMemoSet3('${barcode}')" style="font-size: 12px; margin-top:-2px;  height:28px;" id="ok2">적용</button> <br>
												...
												<tr>
													...
													<td width="49%">
														<table
															...
															<tr style="height: 25%">
																<td rowspan="4"
																	style="font-size: 11px; text-align: center; width: 20%">공<br>급<br>받<br>는<br>자
																</td>
																<td style="font-size: 11px; text-align: center;">번호
																</td>
																<td colspan="3"
															...
															<tr style="height: 25%">
																...
																<td
																	style="font-size: 5px; text-align: center; word-break: break-all;">(주)우보테크
																</td>
																<td style="font-size: 11px; text-align: center;">성명</td>
															...
															<tr style="height: 25%">
																<td
																	style="font-size: 11px; text-align: center; width: 20%">주소</td>
																<td colspan="3"

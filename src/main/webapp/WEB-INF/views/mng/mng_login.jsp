						...
						<div class="card2 card border-0 px-4 py-5">
							...
							<div class="row px-3">
								<label class="mb-1">
									...
									placeholder="<spring:message code="EnterBusiness" text="EnterBusiness"/>">
							</div>
							<div class="row px-3">
								<label class="mb-1">
									<h6 class="mb-0 text-sm">
									...
									placeholder="<spring:message code="EnterPassword" text="EnterPassword"/>">
							</div>
			...
			<div class="bg-blue py-4">
				<div class="row px-3">
					...
					<div class="ml-4 ml-sm-auto">
						<span class="fa mr-4 text-sm">※ 본 사이트는 윈도우 10과 1920 x 1080
							해상도에 최적화 되어있습니다. 브라우저는 크롬, 엣지 사용에서 동작합니다.&nbsp;&nbsp;						
							...
							<a href="https://www.google.co.kr/chrome/thank-you.html?brand=CHBD&statcb=1&installdataindex=empty&defaultbrowser=0#">크롬 다운로드</a></img>												
							<img src="resources/img/edge.PNG" onclick="location.href='https://www.microsoft.com/ko-kr/edge'"><a href="https://www.microsoft.com/ko-kr/edge">엣지 다운로드</a></img>							
						</span>
					</div>
				</div>
			</div>

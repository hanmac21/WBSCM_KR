			...
			<section class="content">
				...
				<div class="row" style="width: 100%; margin-bottom: 5px; padding-bottom: 5px;">
					...
					<div class="col-xs-12" style="padding-right: 0px;">
						...
						<input type="text" id="startdate" name="startdate" value="${startdate }" style="width:125px; margin-right: 10px;"" readonly autocomplete="off"/>	
									...
									<table id="tablebody" width="100%"
										...
										<thead>
											<tr>
												...
												<th style="text-align: center;">예상재고</th>
											</tr>
										</thead>
										<tbody>
											<c:choose>
												<c:when test="${ board.size() > 0 }">
													<c:forEach var="vo" items="${ board }" varStatus="status">
														...
														<tr>
															...
															<td>${vo.day13}</td>
															<td>${vo.day14}</td>
															<td>${vo.day1+vo.day2+vo.day3+vo.day4+vo.day5+vo.day6+vo.day7+vo.day8+vo.day9+vo.day10+vo.day11+vo.day12+vo.day13+vo.day14}</td>
															<td>${vo.stock_qty-vo.plan_qty+vo.day1+vo.day2+vo.day3+vo.day4+vo.day5+vo.day6+vo.day7+vo.day8+vo.day9+vo.day10+vo.day11+vo.day12+vo.day13+vo.day14}</td>
														</tr>
...
//★★★★★삭제예정220721★★★★★시작
		...
		function showExcel(){
			...
			window.open("mng_production_plan_excel?startdate="+startdate+"&alldtate="+alldtate+"&branch="+branch,"Buy Plan Excel",'height=500,width=750');
		}
		//★★★★★삭제예정220721★★★★★끝
	</script>

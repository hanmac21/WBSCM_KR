...
<div class="modal-dialog" style="max-width: 100%;width:auto;display:table;">
	...
	<div class="modal-content">
		<div style="margin-top:10px; margin-left:10px; padding-top:10px;">
			...
			<h4 class="modal-title" style="margin-bottom:5px; margin-top:10px; bottom-border:3px solid #00C0EF">사용자관리</h4>
		</div>
		...
		<div style="padding:10px;">
			<table class="manageV">
				<thead >
					...
					<tr>
						<th style="width:50%; text-align:center" class="mng3 manageV">평택 평균배송 소요시간</th>
					...
					<tr>
						<th style="width:50%; text-align:center" class="mng3 manageV">직납</th>
						<td class="mng4 manageV"><select id="ment" style="width:180px;">
								<option value="<%=text %>"  ${ment =='001' ? 'selected' :'' }><%=text %></option>
								<option value="우보테크" ${ment =='002' ? 'selected' :'' }>우보테크</option>
								<option value="우보테크[<%=text %>]"  ${ment =='000' ? 'selected' :'' }>우보테크[<%=text %>]</option>
							</select></td>
					</tr>
				...
				<tbody style="margin-top:20px;">
					<tr>
						<th style="width:50%; text-align:center; font-size:14px;" class="mng3 manageV">이메일</th>
						<th style="width:50%; text-align:center; font-size:14px;" class="mng3 manageV">이름</th>
					</tr>
					<tr>
		...
		<div class="modal-footer" >
			<div >
				<button type="button" class="btn btn-primary" onclick="fnMangerSave()">변경</button>

      ...
      <!-- /.container-fluid -->
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<span style="float:left; font-size: 30px;">공지사항</span>
        ...
        <li class="active">Dashboard</li>
			...
			<section class="content">
				...
				<div class="row" style="width: 100%; margin-bottom: 5px; padding-bottom: 5px;">
					<!-- 공통 검색 조건 -->
						<!-- 공통 검색 조건 2022-04-22 정인우 -->
						<div class="col-xs-12" style="padding-right: 0px;">
							<span> 등록일자 : </span> &nbsp;
							<!-- <input type="text" id="startdate"	name="startdate" autocomplete="off" style="margin-right:5px; width: 100px"> -->
							<input type="text" id="startdate" name="startdate" autocomplete="off" style="width:125px; margin-right:5px;" placeholder="연도-월-일"/>
							~
							<!-- <input type="text" id="enddate" name="enddate"	autocomplete="off" style="margin-right: 20px; width: 100px">  -->
							<input type="text" id="enddate" name="enddate" autocomplete="off" style="width:125px; margin-right:20px;" placeholder="연도-월-일"/>

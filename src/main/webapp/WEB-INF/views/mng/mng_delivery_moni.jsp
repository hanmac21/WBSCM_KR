...
<div class="wrapper" style="background: #002060;">
	...
	<div style="font-size: 22px; text-align: center; display:flex;">
		...
		<div align="center" style="float: left; width: 33%;">
			<span>납품 현황 총 ${totalCount } 건</span>
		</div>
		...
		<table id="tablebody" width="100%"
			...
			<thead style="padding-buttom: 30px;">
				<tr class="line head">
					<th style="font-size: 20px; text-align: center; width: 18%;">업 체 명<br>(Name)
					</th>
					<th style="font-size: 20px; text-align: center; width: 24%;">품 목<br>(Item)
					</th>
					<th style="font-size: 20px; text-align: center; width: 8%;">출발 지역<br>(From)
					</th>
					<th style="font-size: 20px; text-align: center; width: 10%;">출발 시간<br>(Dep Time)
					</th>
					<th style="font-size: 20px; text-align: center; width: 10%;">도착 예정 시간<br>(Arrive
						Time)
					</th>
					<th style="font-size: 20px; text-align: center; width: 10%;">지연 시간<br>(Delay Time)
					</th>
					<th style="font-size: 20px; text-align: center; width: 11%;">상태<br>(Status)
					</th>
					<th style="font-size: 20px; text-align: center; width: 9%;">납품 list 조회<br>(Delivery
						list)
					</th>
				</tr>
			</thead>
					...
					<c:when test="${ board.size() >= 10 }">
						<c:forEach var="vo" items="${board }">
							<tr class="line" id="line+${vo.row_num }">
								...
								<td style="font-size: 22px; text-align: center;">
									<button class="btn btn-secondary" type="button" style="color: black; font-size: 22px; width: 80px;" onclick="show_list('${vo.cno}');">${vo.cnt }건</button>
								</td>
							</tr>
						</c:forEach>
					</c:when>
	...
	<div class="" style="padding-top: 0px; width: 33%; float: left;">
		<div class="custom-control custom-checkbox text-left" style="padding-left: 15px;">
			...
			<label class="custom-control-label" for="auto_chk" style="argin-left: 15px;">페이지 자동 이동</label>
		</div>

				...
				<div class="row" style="width: 100%; margin-bottom: 5px; padding-bottom: 5px;">
					...
					<div class="col-xs-12" style="padding-right: 0px;">
						<%-- <span>영업계획일자 : </span> &nbsp;<input type="text" id="startdate"
							...
							autocomplete="off" value="${startdate}" /> <span>공장 : </span>
...
//★★★★★삭제예정220721★★★★★ 시작
	...
	function showExcel(){
		...
		var branch = getCookie("branch");
		$("#branch").val(branch);
		window.open("mng_biz_plan_excel?startdate="+startdate+"&branch="+branch,"Buy Plan Excel",'height=500,width=750');
	}

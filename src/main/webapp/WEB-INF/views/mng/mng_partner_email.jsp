...
<body>
	<div class="border border-info p-4 rounded">
		<h3 style="position: relative;top: 10px;left: 100px;font-size: 40px;">E-MAIL 발송</h3>
		...
		<form action="/mail/send" id="send" method="POST">
			...
			<div class="form-group" style="position: absolute;left: 100px;top: 530px;">
                <label for="gender">
                  ...
                  <span class="align-middle" style="font-size: 25px;">이메일 선택</span>
                </label>
               <table>
			...
			<div class="form-group" style="position: absolute;top: 140px;left: 100px;">
				<label for="subject">
					<!-- <i class="material-icons align-middle">account_box</i> -->
              	    <span class="align-middle" style="font-size: 25px;">제목</span>
				</label>
				<input type="text" class="form-control" id="subject" aria-describedby="idHelp" name="subject" placeholder="E-Mail 제목을 입력해주세요." required autofocus style="width: 450px;height: 50px;">
			...
			<div class="form-group" style="position: absolute;top: 260px;left: 100px;">
                <label for="content">
                 <!--  <i class="material-icons align-middle">lock</i> -->
                  <span class="align-middle" style="font-size: 25px;">내용</span>
                </label>
                <!-- <input type="" class="form-control" id="content" aria-describedby="pwdHelp" name="content" placeholder="E-Mail 내용을 입력해주세요." required> -->
                <textarea class="form-control" id="content" aria-describedby="pwdHelp" name="content" placeholder="E-Mail 내용을 입력해주세요." style="width: 450px;height: 200px;resize: none;"></textarea>
            ...
            <div class="my-3 text-center" style="position: absolute;left: 410px;top: 30px;">
                <button type="button" id="btnadd" class="btn btn-primary" onclick="javascript:MailSend();" style="width: 140px;height: 40px;">E-Mail보내기</button>
	...
	<script type="text/javascript">
		...
		function MailSend() {
			...
			if (sub == '') {
				...
				alert("전송할 EMAIL 을 최소 1개라도 정하셔야됩니다.");
			}else{
				$('#send').submit();
			}

      ...
      <!-- /.container-fluid -->
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<span style="float:left; font-size: 30px;">재고조회</span>
        ...
        <li class="active">Dashboard</li>
			...
			<section class="content">
				...
				<div class="row" style="width: 100%; margin-bottom: 5px; padding-bottom: 5px;">
					...
					<div class="col-xs-12" style="padding-right: 0px;">
						...
						<input type="text" id="startdate" name="startdate" value="${startdate }" style="width:125px; margin-right:10px;" readonly/>
							...
							<span> 공장 : </span> &nbsp;<select id="branch" name="branch" style="margin-right:10px; height: 27px;">
				...
				<span>조회조건 : </span> &nbsp;<select
							...
							<option value="0" ${alldtate =='0' ? 'selected' :'' }>재고품목</option>
							<option value="1" ${alldtate =='1' ? 'selected' :'' }>전체품목</option>
						</select>
				
			
				
							<span> 차종 : </span> &nbsp;<input type="text" id="p_carname"	 autocomplete="off"	name="p_carname" style="margin-right:10px; width: 100px;"	value="" 
							onKeypress="javascript:if(event.keyCode==13) {getUserList('1')}"
							/>	
							
						    <span> 품명 : </span> &nbsp;<input type="text" id="p_itemname"	autocomplete="off"	name="p_itemname" style="margin-right:10px; width: 100px"	value="" 
						    onKeypress="javascript:if(event.keyCode==13) {getUserList('1')}"
						    />	
						    
						    <span> 품번 : </span> &nbsp;<input type="text" id="p_itemcode1"	autocomplete="off"	name="p_itemcode1" style="margin-right:10px; width: 100px"	value="" 
						    onKeypress="javascript:if(event.keyCode==13) {getUserList('1')}"
						    />	
							...
							<input type="button" class="btn btn-success" value="엑셀 저장" onclick="showExcel();" style="margin-left: 50px;"/>

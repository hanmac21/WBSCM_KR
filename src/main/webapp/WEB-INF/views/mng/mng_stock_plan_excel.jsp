      ...
      <!-- /.container-fluid -->
		...
		<div class="content-wrapper">
			...
			<!-- <section class="content-header">
				<span style="float:left; font-size: 30px;">재고현황</span>
			...
			<section class="content">
				...
				<div class="row" style="width: 100%; margin-bottom: 5px; padding-bottom: 5px;">
					...
					<div class="col-xs-12" style="padding-right: 0px;">
						<%-- <span>조회일자 : </span> &nbsp;<input type="text" id="startdate" 	name="startdate" style="margin-right:15px; width: 100px" autocomplete="off"	 value="${startdate}" /> &nbsp;
							<span> 공장 : </span> &nbsp;<select id="branch" name="branch" style="margin-right:15px;">
				...
				<option value="001" ${branch =='001' ? 'selected' :'' }>울산</option>
							...
							<%-- <span> 차종 : </span> &nbsp;<input type="text" id="p_carname"	 autocomplete="off"	name="p_carname" style="margin-right:15px; width: 100px"	value="" 
							onKeypress="javascript:if(event.keyCode==13) {getUserList('1')}"
							/>	
							
							&nbsp;
						    <span> 품번 : </span> &nbsp;<input type="text" id="p_itemcode1"	autocomplete="off"	name="p_itemcode1" style="margin-right:15px; width: 100px"	value="" 
						    onKeypress="javascript:if(event.keyCode==13) {getUserList('1')}"
						    />	
						    
						    &nbsp;
						    <span> 품명 : </span> &nbsp;<input type="text" id="p_itemname"	autocomplete="off"	name="p_itemname" style="margin-right:15px; width: 100px"	value="" 
						    onKeypress="javascript:if(event.keyCode==13) {getUserList('1')}"
						    />	
						    
						    &nbsp;	
							<%if("master".equals(admin)){%>
							<span> 거래처 : </span> &nbsp;<input type="text" id="p_name"	autocomplete="off"	name="p_name" style="margin-right:15px; width: 100px"	value="" 
							onKeypress="javascript:if(event.keyCode==13) {getUserList('1')}"
							/>
							<%} %>	
							...
							<input type="button" class="btn btn-warning" onclick="getUserList('1')" value="조회하기" style="margin-left: 25px;" id="start"/> --%>
							<!-- <input type="button" class="btn btn-success" id="btexe" onclick="export()" value="엑셀저장"	 style="margin-left: 25px;" />  -->
							
							<input type="button" class="btn btn-success" value="엑셀 저장" onclick="export()" id="xls"/>
							...
							<div class="box">
								...
								<div class="box-body" style="overflow: scroll;">
									...
									<table id="tablebody" width="100%" class="stripe row-border order-column" cellspacing="0" >
										...
										<thead>
											<tr>
												<th rowspan="3"style="text-align: center;">순번</th>

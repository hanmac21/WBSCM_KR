...
<div class="modal-dialog modal-dialog-scrollable" style="width: 80%" >
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title">협력사 게시글 등록</h4>
				...
				<form class="form-horizontal" name="form1" id="form1" method="post">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="name" class="col-sm-2 control-label">협력사</label>
							...
							<div class="input-group input-group-sm"	>
								<input type="text" class="form-control" name="p_cno" id="p_cno"	placeholder="협력사번호" 	value=""  style="width: 25%" readonly="readonly" > 
								<input type="text" class="form-control" name="p_cu_sangho" id="p_cu_sangho"	placeholder="협력사명"	value=""  style="width: 45%" readonly="readonly">
						...
						<%} else{%>
							<input type="hidden" class="form-control" name="p_cno" id="p_cno"	placeholder="협력사번호" 	value="-1"  style="width: 25%" readonly="readonly" > 
								<input type="hidden" class="form-control" name="p_cu_sangho" id="p_cu_sangho"	placeholder="협력사명"	value=""  style="width: 45%" readonly="readonly">
						<%} %>	
